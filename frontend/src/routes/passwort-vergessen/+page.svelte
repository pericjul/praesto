...
<svelte:head><title>Passwort vergessen – Praesto</title></svelte:head>
...
<style>
	...
	.sub { color: #6b647a; font-size: 0.92rem; margin: 0 0 1.25rem; line-height: 1.55; }
	...
	.foot { margin: 1.25rem 0 0; font-size: 0.88rem; }
	.foot a { color: #6b647a; }
</style>

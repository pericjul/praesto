...
export const actions = {
	default: async ({ request, locals, fetch }) => {
		...
		const payload = {
			...
			senderStreet: d.get("senderStreet"),
			senderZipCity: d.get("senderZipCity"),
			phone: d.get("phone"),
			email: d.get("email"),
			companyName: d.get("companyName"),
			contactPerson: d.get("contactPerson"),
			companyStreet: d.get("companyStreet"),
			companyZipCity: d.get("companyZipCity"),
			place: d.get("place"),
			letterDate: d.get("letterDate"),

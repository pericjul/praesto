<script>
  ...
  // Hat der User eine offene Session?
  const hasOpenSession = !!openSessionId;
</script>
...
<div class="dashboard-page">
  ...
  <section class="hero-card">
    <div class="hero-left">
      ...
      <div class="hero-actions">
        ...
        {#if hasOpenSession}
          <a href="/student/sessions/{openSessionId}" class="btn btn-ghost">▶️ Training fortsetzen</a>
        {:else}
  ...
  <section class="grid">
    ...
    <article class="card">
      ...
      <footer class="card-footer">
        {#if hasOpenSession}
          <a href="/student/sessions/{openSessionId}" class="btn btn-inline">▶️ Fortsetzen</a>
        {:else}
    ...
    <article class="card">
      ...
      <footer class="card-footer card-footer--disabled">
        <span class="btn btn-inline disabled">Notizen bald verfügbar</span>
      </footer>
    </article>
  </section>
</div>

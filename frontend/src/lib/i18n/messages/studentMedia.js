export const studentMedia = {
	de: {
		...
		"ssess.quotaLeft": "Noch %N% von %T% freien Übungsgesprächen",
		"ssess.quotaEmpty": "Freie Übungsgespräche aufgebraucht – Aufgaben deiner Lehrperson gehen weiterhin.",
	...
	en: {
		...
		"ssess.quotaLeft": "%N% of %T% free practice interviews left",
	...
	fr: {
		...
		"ssess.quotaLeft": "Encore %N% sur %T% entretiens d'entraînement libres",
	...
	it: {
		...
		"ssess.quotaLeft": "Ancora %N% su %T% colloqui di allenamento liberi",

export const studentMedia = {
	de: {
		...
		"ssess.quotaLeft": "Heute noch %N% freies Übungsgespräch · morgen wieder verfügbar",
		"ssess.quotaEmpty": "Heute schon geübt – morgen gibt's wieder 1 freies Gespräch. Aufgaben deiner Lehrperson gehen weiterhin.",
	...
	en: {
		...
		"ssess.quotaLeft": "%N% free practice interview left today · refills tomorrow",
		"ssess.quotaEmpty": "Free practice interviews used up – teacher assignments still work.",
	...
	fr: {
		...
		"ssess.quotaLeft": "Encore %N% entretien d'entraînement aujourd'hui · réinitialisé demain",
		"ssess.quotaEmpty": "Entretiens d'entraînement libres épuisés – les devoirs de l'enseignant restent possibles.",
	...
	it: {
		...
		"ssess.quotaLeft": "Ancora %N% colloquio di allenamento oggi · si rinnova domani",
		"ssess.quotaEmpty": "Colloqui di allenamento liberi esauriti – i compiti dell'insegnante restano possibili.",

...
export const handbookEn = {
	...
	en: {
		...
		"hb.teacher.asgP": "Create tasks with a title, description and deadline. A task is assigned to one class (chosen from the dropdown). There are five task types:",
		...
		"hb.faq.q3": "How do I assign a task to several classes?",
		"hb.faq.a3": "Each task uses one class from the dropdown. For another class, simply create the task again.",
		...
		"hb.support.p1": "Questions or requests? We're happy to help. Write to us at info@praesto.ch."
	},
	fr: {},
	it: {}
};
